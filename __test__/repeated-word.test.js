...
const repeatedWord = require('../repeated-word/repeated-word');

describe('repeatedWord', () => {
  it('repeatedWord test ', () => {
    ...
    expect(repeatedWord('How are you, fine thank you teacher')).toEqual('you');
    expect(repeatedWord('How are you,')).toEqual('none');
  });
});
